...
IMPORTANT:
- The context provided is for the fund: {target_scheme}
- If the user's question uses a different name, shorthand, or simply says "the fund", assume they are referring to {target_scheme}.
- You MUST answer the question using the facts in the provided context, even if the user uses a slightly different name than what appears in the context.
