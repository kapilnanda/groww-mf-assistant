...
5. Synonyms: 'HDFC Mid Cap Fund' is also known as 'HDFC Mid-Cap Opportunities Fund'. 'HDFC ELSS Tax Saver' is also known as 'HDFC ELSS'. Assume these refer to the same entity.
"""),
            ("user", """Context:
{context}
