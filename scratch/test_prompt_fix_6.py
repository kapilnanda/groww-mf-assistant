...
5. FLEXIBILITY: If the user asks about a fund that is clearly the same as the one in the context (e.g., matching keywords like "Mid Cap"), answer using the context despite minor name variations.
"""),
            ("user", """Context:
{context}
